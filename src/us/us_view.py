...
This module provides the view component for the user settings interface.
It implements the graphical user interface elements that allow the user to
control the simulation, including start/stop buttons, reset functionality,
continuous/discrete mode selection, speed control, and parameter sliders
for the Gaussian function and growth function.
"""
...
# pylint raise a warning for the class attribute number. It's ok, it's a UI class
class UsView: # pylint: disable=R0902
