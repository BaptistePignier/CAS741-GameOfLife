...
Inputs will be entered manually, and output will be compared visually with that of another Game of Life simulation software.
...
Condition: An inexperienced third party will be asked to run a simulation and modify its parameters, without any further guidance.
					
Result: The test will be passed if the third party successfully completes the task.
